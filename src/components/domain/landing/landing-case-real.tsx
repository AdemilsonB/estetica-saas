  ...
  return (
    <section className="bg-white px-4 py-16 sm:px-6 sm:py-20">
      <Reveal className="mx-auto max-w-3xl">
        <div className="rounded-none border-t-[3px] border-[#B9673C] bg-[#2E2A26] p-8 text-white shadow-2xl sm:p-11">
          <p className="text-xs font-extrabold uppercase tracking-wide text-[#C98B7A]">
          ...
          <div className="mt-6 border-t border-white/20 pt-5">
            ...
            <div className="text-sm text-[#C98B7A]">{testimonial.authorRole}</div>
          </div>
        </div>
      </Reveal>
    </section>
