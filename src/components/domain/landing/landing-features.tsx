    ...
    <section id="funcionalidades" className="bg-white px-4 py-16 sm:px-6 sm:py-20">
      <div className="mx-auto max-w-6xl">
        <Reveal className="mb-10 text-center sm:mb-14">
          <p className="text-sm font-extrabold uppercase tracking-wide text-[#B9673C]">Tudo num lugar só</p>
          <h2 className="font-display mt-3 text-[clamp(1.6rem,4.5vw,2.4rem)] font-extrabold text-[#2E2A26]">
        ...
        <div className="grid gap-5 sm:grid-cols-2 md:grid-cols-3">
          {FEATURES.map((feature, i) => (
            <Reveal key={feature.title} delay={(i % 3) * 80}>
              <div className="h-full rounded-none border-t-[3px] border-[#EDE1D1] bg-[#FBF4EA]/60 p-6">
