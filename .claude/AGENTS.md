...
|---|---|---|
| **Onboarding** | `skills/agent-onboarding.md` | **Primeiro passo** — toda ideia nova passa aqui |
| **Orchestrator** | `skills/orchestrator.md` | Executa o brief estruturado pelo Onboarding |
| **Database** | `skills/agent-database.md` | Schema Prisma, migrations, RLS |
| **Backend** | `skills/agent-backend.md` | Services, repos, API Routes, Zod schemas |
| **Frontend** | `skills/agent-frontend.md` | Pages, components, hooks de UI |
| **Testing** | `skills/agent-testing.md` | Vitest, testes unit + integração |
| **Security** | `skills/agent-security.md` | Auditoria OWASP, tenancy, rate limiting |
| **Review** | `skills/agent-review.md` | Gate de build final, aprovação de PR |
| **Documentation** | `skills/agent-documentation.md` | Atualiza docs após cada feature |
| **Arquiteto** | `skills/agent-architect.md` | Decisões arquiteturais novas |
